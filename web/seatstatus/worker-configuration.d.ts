/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env worker-configuration.d.ts` (hash: aa684535f15a2716114c9885a89d20ed)
// Runtime types generated with workerd@1.20260305.0 2026-02-26 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SeatStatusDO";
	}
	interface Env {
		SEAT_STATUS: KVNamespace;
		SEAT_MAP_MODE: "snapshot";
		DETAIL_FETCH_CONCURRENCY: "10";
		DETAIL_FETCH_LIMIT: "250";
		ACTIVE_POLL_SECONDS: "5";
		IDLE_POLL_SECONDS: "3600";
		SEAT_STATUS_DO: DurableObjectNamespace<import("./src/index").SeatStatusDO>;
	}
}
