...
[ -n "$BANNER_AD_UNIT_ID" ] && echo "BANNER_AD_UNIT_ID = $BANNER_AD_UNIT_ID" >> "$OUT_FILE"
[ -n "$INTERSTITIAL_AD_UNIT_ID" ] && echo "INTERSTITIAL_AD_UNIT_ID = $INTERSTITIAL_AD_UNIT_ID" >> "$OUT_FILE"
