...
public final class MethodCallHandlerImpl implements MethodCallHandler {
  ...
  private static Bundle convertArguments(Map<String, ?> arguments) {
    ...
    for (Map.Entry<String, ?> entry : arguments.entrySet()) {
      ...
      if (value instanceof Integer) {
        ...
        bundle.putIntegerArrayList(key, castArrayList(value));
      } else if (isTypedArrayList(value, String.class)) {
        bundle.putStringArrayList(key, castArrayList(value));
  ...
  private static Bundle convertArrayArguments(Map<String, ?> arrayArguments) {
    ...
    for (Map.Entry<String, ?> entry : arrayArguments.entrySet()) {
      String key = entry.getKey();
      Object value = entry.getValue();
      if (isTypedArrayList(value, Boolean.class)) {
        ArrayList<Boolean> list = castArrayList(value);
        ...
        ArrayList<Integer> list = castArrayList(value);
        ...
        ArrayList<Long> list = castArrayList(value);
        ...
        ArrayList<Double> list = castArrayList(value);
        ...
        ArrayList<String> list = castArrayList(value);
  ...
  private static <T> ArrayList<T> castArrayList(Object value) {
