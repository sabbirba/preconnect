    ...
    return BracuPageScaffold(
      ...
      body: BracuRefreshList(
        ...
        children: isInitialLoading
            ? const [
                SizedBox(height: 8),
                BracuLoading(height: 220, radius: 18),
                SizedBox(height: 18),
                ...
                SizedBox(height: 10),
                BracuCard(child: BracuLoading(height: 80, radius: 14)),
                SizedBox(height: 18),
                BracuSectionTitle(title: 'Personal Info'),
                SizedBox(height: 10),
                BracuLoading(itemCount: 3, compact: true),
                SizedBox(height: 18),
                BracuSectionTitle(title: 'Attendance'),
                SizedBox(height: 10),
                BracuLoading(height: 160, radius: 16),
                SizedBox(height: 18),
